...
public class UserController {
    ...
    public @ResponseBody
    String deleteUser(@RequestParam(value = "user") String useridorname, @CurrentUser UserPrincipal principal) {
    ...
    public @ResponseBody
    String toggleAdmin(@RequestParam(value = "user") String useridorname, @CurrentUser UserPrincipal principal) {
    ...
    @GetMapping("/allusers")
    public @ResponseBody
    List<User> getAllUsers(@CurrentUser UserPrincipal principal) {
        return userService.listAll(principal);
    }
}
